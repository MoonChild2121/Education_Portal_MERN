...
import Qs1 from './audios/breathes.m4a';
import Qs2 from './audios/sci l3 q2.m4a';
import Qs3 from './audios/sci l3 q3.m4a';
import Qs4 from './audios/sci l3 q4.m4a';
import Qs5 from './audios/sci l3 q5.m4a';
...
function Quiz() {
  ...
  const questions = [
    {
      text: "Which of the following breathes? ",
      options: [
        { id: 0, text: "Plane", isCorrect: false },
        { id: 1, text: "Parrots", isCorrect: true },
        { id: 2, text: "Ice", isCorrect: false },
        { id: 3, text: "Water", isCorrect: false },
      ],
    },
    {
      text: "Which of the following needs food?",
      options: [
        { id: 0, text: "Car", isCorrect: false },
        { id: 1, text: "Rabbit", isCorrect: true },
        { id: 2, text: "Table ", isCorrect: false },
        { id: 3, text: "Chai", isCorrect: false },
      ],
    },
    {
      text: "Which of the following moves?",
      options: [
        { id: 0, text: "Car", isCorrect: true },
        { id: 1, text: "Rock", isCorrect: false },
        { id: 2, text: "Chair", isCorrect: false },
        { id: 3, text: "Table", isCorrect: false },
      ],
    },
    {
      text: "Which of the following reproduces?",
      options: [
        { id: 0, text: "Apple", isCorrect: false },
        { id: 1, text: "Car", isCorrect: false },
        { id: 2, text: "Crayon", isCorrect: false },
        { id: 3, text: "Animals", isCorrect: true },
      ],
    },
    {
      text: "Which of the following is living?",
      options: [
        { id: 0, text: "Honey", isCorrect: false },
        { id: 1, text: "Birds", isCorrect: true },
