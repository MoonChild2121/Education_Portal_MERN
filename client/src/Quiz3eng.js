...
import Qs1 from './audios/English l3 q1.m4a';
import Qs2 from './audios/English l3 q2.m4a';
import Qs3 from './audios/English l3 q3.m4a';
import Qs4 from './audios/english l3 q4.m4a';
import Qs5 from './audios/enligsh l3 q5.m4a';
...
function Quiz() {
  ...
  const questions = [
    {
      text: "What does the word mean? : Confident ",
      options: [
        { id: 0, text: "Having or showing assurance and self-reliance", isCorrect: true },
        { id: 1, text: "Being afraid", isCorrect: false },
        { id: 2, text: "Having a liking for someone", isCorrect: false },
        { id: 3, text: "Forgetting something", isCorrect: false },
      ],
    },
    {
      text: "What does the word mean? : Imitate",
      options: [
        { id: 0, text: "To make something better", isCorrect: false },
        { id: 1, text: "To comment on something", isCorrect: false },
        { id: 2, text: "To copy something", isCorrect: true },
        { id: 3, text: "To describe something ", isCorrect: false },
      ],
    },
    {
      text: "What does the word mean? : Govern",
      options: [
        { id: 0, text: "To compliment", isCorrect: false },
        { id: 1, text: "To rule", isCorrect: true },
        { id: 2, text: "To feel happy", isCorrect: false },
        { id: 3, text: "To talk to a person you don’t know", isCorrect: false },
      ],
    },
    {
      text: "What does the word mean? : Precious",
      options: [
        { id: 0, text: "Old", isCorrect: false },
        { id: 1, text: "Boring", isCorrect: false },
        { id: 2, text: "Valuable and rare", isCorrect: true },
        { id: 3, text: "Forgettable ", isCorrect: false },
      ],
    },
    
    {
      text: "What does the word mean? : Enraged",
      options: [
        { id: 0, text: "Made angry", isCorrect: true },
        { id: 1, text: "The range of a weapon", isCorrect: false },
        { id: 2, text: "Made happy", isCorrect: false },
        { id: 3, text: "A jar to store money", isCorrect: false },
      ],
    },
  ];
    ...
    <div style={{ backgroundImage: `url(${engpic})`, height: "100vh" }}>
      ...
      {showResults ? (
        ...
        <div id="finalreseng" className="final-results">
          ...
          <a href="Lesson3eng"><button id="buttonquizeng">Lesson</button></a>
        </div>
      ) : (
        /* 5. Question Card  */
