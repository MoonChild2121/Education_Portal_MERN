...
import "./quizeng.css";
import Catto from './audios/quiz tutorial.m4a';
import Qs1 from './audios/math l4 q1.m4a';
import Qs2 from './audios/math l4 q2.m4a';
import Qs3 from './audios/math l4 q3.m4a';
import Qs4 from './audios/math l4 q4.m4a';
import Qs5 from './audios/math l4 q5.m4a';
    ...
    <div style={{ backgroundImage: `url(${mathbg})`, height: "100vh" ,backgroundRepeat: "no-repeat", backgroundSize: "cover"}}>
      ...
      {showResults ? (
        ...
        <div id="finalresmath" className="final-results">
          ...
          <a href="Lesson4maths"><button id="buttonquizmath">Lesson</button></a>
        </div>
      ) : (
        /* 5. Question Card  */
