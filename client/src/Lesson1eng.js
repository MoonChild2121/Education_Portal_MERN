...
function Lesson1eng() {
  ...
  const soundRef = useRef(null); // Use useRef to store a reference to the audio object
  useEffect(() => {
        ...
        <div  className="container">
          ...
          <div  className="row"> 
            <div  className="col-lg-4 pb-5 pb-lg-0">
              <a href='https://www.youtube.com/watch?v=TWnHEioYqls'  target="_blank">
            ...
            <div  className="col-lg-4 pb-5 pb-lg-0">
              <a href='https://drive.google.com/drive/folders/1-6B3I8Qlga1PIJEORokL3YlN3PmqMbHQ'  target="_blank">  {/* Link to reading */}
                <div  className="wrap-price float-left">
                  <div  className="price-innerdetail text-center float-left">
            ...
            <div className="col-lg-4 pb-5 pb-lg-0">  
              <a href='./Quiz1eng' onClick={()=>incUserEnglish(1)}>
                <div  className="wrap-price float-left">
                  <div  className="price-innerdetail text-center float-left">
