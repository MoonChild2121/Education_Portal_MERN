...
function Lesson3sci() {
  ...
  const incUserScience = (id) => {
    axios.post("http://localhost:3001/incUserScience", {
      name: name,
      password: password,
      id: id
    }, {
      ...
      if (response.data === "User not found") {
        ...
        const updatedUsers = listOfUsers.map(user => {
          if (user.name === name && user.password === password) {
            if (user.LessonsScience[id - 1].state == 1) {
              // lesson already completed
              return { ...user, LessonsScience: user.LessonsScience };
            }else{
              // lesson not completed
              return {
                ...user,
                LessonsScience: user.LessonsScience.map(lesson => {
                  if (lesson.id === id) {
    ...
    <a href='./Subjects'><button className='btn btn-primary homebtn' ><i class="fa-solid fa-house"></i></button></a>
        <div  className="row justify-content-center gapsectionsecond">
            <div  className="col-lg-7 text-center">
                <div  className="title-big">
                    <h1 id='lesson1heading'>Lesson 3</h1>
        ...
        <div  className="row"> 
            ...
            <a href='https://www.youtube.com/watch?v=p51FiPO2_kQ'  target="_blank">
            ...
            <div  className="col-lg-4 pb-5 pb-lg-0">
            <a href='https://drive.google.com/drive/folders/1-6SoNAI0F7qE6KY2JDiHMoZ7uoyQcS3w'  target="_blank">  {/* Link to reading */}
                <div  className="wrap-price float-left">
                <div  className="price-innerdetail text-center float-left">
            ...
            <div  className="col-lg-4 pb-5 pb-lg-0">
            <a href='./Quiz3sci' onClick={()=>(incUserScience(3))}> {/* Link to quiz */}
                <div  className="wrap-price float-left">
                <div  className="price-innerdetail text-center float-left">
