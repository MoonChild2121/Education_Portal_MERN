...
import Qs1 from './audios/matter.m4a';
import Qs2 from './audios/sci l1q2.m4a';
import Qs3 from './audios/sci l1q3.m4a';
import Qs4 from './audios/sci l1 q4.m4a';
import Qs5 from './audios/sci l1q5.m4a';
...
function Quiz() {
  ...
  const questions = [
    {
      text: "Which one has more matter in it? ",
      options: [
        { id: 0, text: "Apple", isCorrect: true },
        { id: 1, text: "Balloon", isCorrect: false },
      ],
    },
    {
      text: "Which has more mass?",
      options: [
        { id: 0, text: "Apple", isCorrect: true },
        { id: 1, text: "Balloon", isCorrect: false },
      ],
    ...
    {
      text: "Which is made up of solid?",
      options: [
        { id: 0, text: "Apple", isCorrect: true },
        { id: 1, text: "Balloon", isCorrect: false },
      ],
    ...
    {
      text: "Which has more gas?",
      options: [
        { id: 0, text: "Apple", isCorrect: false },
        { id: 1, text: "Balloon", isCorrect: true },
      ],
    },
    {
      text: "Do either consist of liquid?",
      options: [
        { id: 0, text: "Apple", isCorrect: false },
        { id: 1, text: "Balloon", isCorrect: false },
        { id: 2, text: "None", isCorrect: true },
      ],
    },
  ];
    ...
    <div style={{ backgroundImage: `url(${starrysky})`, height: "100vh" ,backgroundRepeat: "no-repeat", backgroundSize: "cover"}}>
      ...
      {showResults ? (
        ...
        <div id="finalressci" className="final-results">
          ...
          <a href="Lesson1sci"><button id="buttonquizsci">Lesson</button></a>
        </div>
      ) : (
        /* 5. Question Card  */
