...
import Qs1 from './audios/math l1 q1.m4a';
import Qs2 from './audios/math l1 q2.m4a';
import Qs3 from './audios/math l1 q3.m4a';
import Qs4 from './audios/math l1 q4.m4a';
import Qs5 from './audios/math l1 q5.m4a';
...
function Quiz() {
  ...
  const questions = [
    {
      text: "How many digits are represented here? | | | | |",
      options: [
    ...
    {
      text: "How many digits do the two of these make? | | + | | | |",
      options: [
    ...
    {
      text: "Which set of toothpicks is bigger? | | | or | | | | | |",
      options: [
    ...
    {
      text: "How many toothpicks remain if you take 2 from a pile of 6?",
      options: [
    ...
    {
      text: "How many fingers would you have if you had three more?",
      options: [
    ...
    <div style={{ backgroundImage: `url(${mathbg})`, height: "100vh" ,backgroundRepeat: "no-repeat", backgroundSize: "cover"}}>
      ...
      {showResults ? (
        ...
        <div id="finalresmath" className="final-results">
          ...
          <a href="Lesson1maths"><button id="buttonquizmath">Lesson</button></a>
        </div>
      ) : (
        /* 5. Question Card  */
